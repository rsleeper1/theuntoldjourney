...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $sql = "SELECT * FROM easyquestions, tips WHERE easyquestions.Tip_ID = tips.Tip_ID AND E_Question_ID=2;";
            ...
            if (!isset($_POST["finalAnswer"])) {
                ...
                goodAlert("Good job! You distracted the evil troll and got by!");
            } else {
                ...
                badAlert("Oh no, the evil troll caught you! You must begin the stage all over!");
            }
        ?>
